...
import { Handshake, Rocket, Settings2, LineChart, ArrowRight } from 'lucide-react'

const steps = [
  {
    title: "Join Market Craft",
    description: "Let’s start your journey! Onboard with us through a quick discovery session to understand your goals.",
    icon: Handshake,
  ...
  },
  {
    ...
    description: "We plan. We launch. We craft a custom digital strategy and kick off campaigns across Meta, Google & more.",
    icon: Rocket,
  ...
  {
    title: "Optimize & Grow",
    description: "Connect with specialists via secure video or in person consultations. Refining every click.We analyze, A/B test, and scale what works — from content to targeting to ad creatives.",
    icon: Settings2,
  ...
  },
  {
    ...
    description: "From traffic to revenue.Enjoy better leads, more conversions, and consistent brand visibility that drives real profit.",
    icon: LineChart,
    color: "bg-soft-blue/20 text-soft-blue",
...
export default function HowItWorks() {
      ...
      <motion.div style={{ opacity, y }} className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-soft-blue max-w-2xl mx-auto">
            4 Steps to Turn Your Brand Into a Growth Machine
          </p>
        </motion.div>
  ...
  <p className="text-lg md:text-xl text-soft-blue max-w-2xl text-center">
    “Partner with us today — and let’s start crafting your digital growth story.”
  </p>
</div>
